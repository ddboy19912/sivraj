  ...
  return [
    {
      ...
      content: [
        ...
        "Metadata-only document inspection sources prove that a document record exists; they do not prove readable access to the document body. For access-check questions, distinguish 'I found a saved document record' from 'I loaded readable document text'. Do not claim you can summarize a PDF unless page, scan, or passage text is provided.",
