...
describe("extractEngineeringMemories", () => {
  it("extracts reusable engineering memories with safe evidence metadata", async () => {
    let prompt = "";
  ...
  it("separates project conventions from global user preferences", async () => {
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
        sourceArtifactId: "artifact-id",
  ...
  it("accepts explicit broad user preferences as global user scope", async () => {
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
        sourceArtifactId: "artifact-id",
  ...
  it("extracts plain text engineering instructions without requiring an instruction file", async () => {
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
        sourceArtifactId: "artifact-id",
  ...
  it("does not promote normal work history into engineering instructions", async () => {
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
        sourceArtifactId: "artifact-id",
  ...
  it("does not turn engineering skill facts into coding preferences", async () => {
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
        sourceArtifactId: "artifact-id",
  ...
  it("extracts architecture decisions as project-scoped engineering memories", async () => {
    let prompt = "";
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
  ...
  it("extracts recurring engineering bugs without inventing root causes", async () => {
    let prompt = "";
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
  ...
  it("extracts project conventions and style rules as project-scoped memories", async () => {
    let prompt = "";
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
  ...
  it("extracts deployment environment requirements while dropping secret metadata", async () => {
    let prompt = "";
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
  ...
  it("extracts security boundaries as scoped implementation constraints", async () => {
    let prompt = "";
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
  ...
  it("rejects malformed or non-engineering extraction rows", async () => {
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
        sourceArtifactId: "artifact-id",
  ...
  it("extracts repo health memories deterministically from agent writebacks", async () => {
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
        sourceArtifactId: "artifact-id",
  ...
  it("extracts review copilot memories from agent writeback user corrections", async () => {
    const result = await extractEngineeringMemories(
      {
        twinId: "twin-id",
        sourceArtifactId: "artifact-id",
