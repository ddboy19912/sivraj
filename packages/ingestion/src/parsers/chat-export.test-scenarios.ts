...
export async function run_parsechatexport_extracts_common_message_arrays_from_json_exports() {
...
export async function run_parsechatexport_falls_back_to_readable_text_for_non_json_exports() {
  const parsed = parseChatExport({
...
export async function run_parsechatexport_extracts_chatgpt_conversation_export_mappings() {
  const parsed = parseChatExport({
      content: JSON.stringify([
        {
...
export async function run_parsechatexport_extracts_claude_conversation_exports() {
  const parsed = parseChatExport({
      content: JSON.stringify({
        conversations: [
          {
...
export async function run_parsechatexport_returns_an_empty_parse_result_for_empty_exports() {
